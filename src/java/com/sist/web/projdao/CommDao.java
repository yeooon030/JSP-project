...
import com.sist.web.proj.Comm;

public class CommDao {
	
	private static Logger logger = LogManager.getLogger(CommDao.class);

	//댓글 리스트 가져오기
	public List<Comm> boardList(long boaNum)
	{
	...
	//댓글 등록
	public int writeComment(Comm comm)
	{
		int count = 0;
		Connection conn = null;
		PreparedStatement pstmt = null;
